...
export const AVAILABLE_ASPIRATIONS: Aspiration[] = [
  // ═══ Animal ═══
  aspiration('friendoftheanimals', 'Friend of the Animals', A, 'Friend of the Animals.webp', 'Animal'),
  // ═══ Athletic ═══
  aspiration('bodybuilder', 'Bodybuilder', A, 'Bodybuilder.webp', 'Athletic'),
  aspiration('extremesportsenthusiast', 'Extreme Sports Enthusiast', A, 'Extreme Sports Enthusiast.webp', 'Athletic'),
  aspiration('championshiprider', 'Championship Rider', A, 'Championship Rider.webp', 'Athletic'),
  // ═══ Creativity ═══
  aspiration('painterextraordinaire', 'Painter Extraordinaire', A, 'Painter Extraordinaire.webp', 'Creativity'),
  aspiration('musicalgenius', 'Musical Genius', A, 'Musical Genius.webp', 'Creativity'),
  aspiration('bestsellingauthor', 'Bestselling Author', A, 'Bestselling Author.webp', 'Creativity'),
  aspiration('masteractor', 'Master Actor / Master Actress', A, 'Master Actor+Master Actress.webp', 'Creativity'),
  aspiration('mastermaker', 'Master Maker', A, 'Master Maker.webp', 'Creativity'),
  aspiration('lordladyoftheknits', 'Lord / Lady of the Knits', A, 'Lord + Lady of the Knits.webp', 'Creativity'),
  // ═══ Deviance ═══
  aspiration('publicenemy', 'Public Enemy', A, 'Public Enemy.webp', 'Deviance'),
  aspiration('chiefofmischief', 'Chief of Mischief', A, 'Chief of Mischief.webp', 'Deviance'),
  aspiration('villainousvalentine', 'Villainous Valentine', A, 'Villainous Valentine.webp', 'Deviance'),
  aspiration('seekerofsecrets', 'Seeker of Secrets', A, 'Seeker of Secrets.webp', 'Deviance'),
  // ═══ Family ═══
  aspiration('successfullineage', 'Successful Lineage', A, 'Successful Lineage.webp', 'Family'),
  aspiration('bighappyfamily', 'Big Happy Family', A, 'Big Happy Family.webp', 'Family'),
  aspiration('vampirefamily', 'Vampire Family', A, 'Vampire Family.webp', 'Family'),
  aspiration('superparent', 'Super Parent', A, 'Super Parent.webp', 'Family'),
  // ═══ Food ═══
  aspiration('masterchef', 'Master Chef', A, 'Master Chef.webp', 'Food'),
  aspiration('mastermixologist', 'Master Mixologist', A, 'Master Mixologist.webp', 'Food'),
  aspiration('appliancewiz', 'Appliance Wiz', A, 'Appliance Wiz.webp', 'Food'),
  aspiration('grilledcheese', 'Grilled Cheese', A, 'Grilled Cheese.webp', 'Food'),
  // ═══ Fortune ═══
  aspiration('fabulouslywealthy', 'Fabulously Wealthy', A, 'Fabulously Wealthy.webp', 'Fortune'),
  aspiration('mansionbaron', 'Mansion Baron', A, 'Mansion Baron.webp', 'Fortune'),
  aspiration('marketmagnate', 'Market Magnate', A, 'Market Magnate.webp', 'Fortune'),
  aspiration('fivestarpropertyowner', 'Five-Star Property Owner', A, 'Five-Star Property Owner.webp', 'Fortune'),
  // ═══ Knowledge ═══
  aspiration('renaissancesim', 'Renaissance Sim', A, 'Renaissance Sim.webp', 'Knowledge'),
  aspiration('nerdbrain', 'Nerd Brain', A, 'Nerd Brain.webp', 'Knowledge'),
  aspiration('computerwhiz', 'Computer Whiz', A, 'Computer Whiz.webp', 'Knowledge'),
  aspiration('mastervampire', 'Master Vampire', A, 'Master Vampire.webp', 'Knowledge'),
  aspiration('archaeologyscholar', 'Archaeology Scholar', A, 'Archaeology Scholar.webp', 'Knowledge'),
  aspiration('spellcraftsorcery', 'Spellcraft & Sorcery', A, 'Spellcraft & Sorcery.webp', 'Knowledge'),
  aspiration('academic', 'Academic', A, 'Academic.webp', 'Knowledge'),
  aspiration('ghosthistorian', 'Ghost Historian', A, 'Ghost Historian.webp', 'Knowledge'),
  // ═══ Location ═══
  aspiration('citynative', 'City Native', A, 'City Native.webp', 'Location'),
  aspiration('strangervillemystery', 'StrangerVille Mystery', A, 'Strangerville Mystery.webp', 'Location'),
  aspiration('beachlife', 'Beach Life', A, 'Beach Life.webp', 'Location'),
  aspiration('mtkomorebisightseer', 'Mt. Komorebi Sightseer', A, 'Mt.Komorebi Sightseer.webp', 'Location'),
  aspiration('perfectlypristine', 'Perfectly Pristine', A, 'Perfectly Pristine.webp', 'Location'),
  aspiration('fabulouslyfilthy', 'Fabulously Filthy', A, 'Fabulously Filthy.webp', 'Location'),
  aspiration('fountoftomaraniknowledge', 'Fount of Tomarani Knowledge', A, 'Fount of Tomarani Knowledge.webp', 'Location'),
  // ═══ Love ═══
  aspiration('serialromantic', 'Serial Romantic', A, 'Serial Romantic.webp', 'Love'),
  aspiration('soulmate', 'Soulmate', A, 'Soulmate.webp', 'Love'),
  aspiration('romanticexplorer', 'Romantic Explorer', A, 'Romantic Explorer.webp', 'Love'),
  aspiration('paragonpartner', 'Paragon Partner', A, 'Paragon Partner.webp', 'Love'),
  // ═══ Nature ═══
  aspiration('freelancebotanist', 'Freelance Botanist', A, 'Freelance Botanist.webp', 'Nature'),
  aspiration('thecurator', 'The Curator', A, 'The Curator.webp', 'Nature'),
  aspiration('anglingace', 'Angling Ace', A, 'Angling Ace.webp', 'Nature'),
  aspiration('outdoorenthusiast', 'Outdoor Enthusiast', A, 'Outdoor Enthusiast.webp', 'Nature'),
  aspiration('jungleexplorer', 'Jungle Explorer', A, 'Jungle Explorer.webp', 'Nature'),
  aspiration('purveyorofpotions', 'Purveyor of Potions', A, 'Purveyor of Potions.webp', 'Nature'),
  aspiration('ecoinnovator', 'Eco Innovator', A, 'Eco Innovator.webp', 'Nature'),
  aspiration('countrycaretaker', 'Country Caretaker', A, 'Country Caretaker.webp', 'Nature'),
  aspiration('crystalcrafter', 'Crystal Crafter', A, 'Crystal Crafter.webp', 'Nature'),
  // ═══ Popularity ═══
  aspiration('jokestar', 'Joke Star', A, 'Joke Star.webp', 'Popularity'),
  aspiration('partyanimal', 'Party Animal', A, 'Party Animal.webp', 'Popularity'),
  aspiration('friendtotheworld', 'Friend of the World', A, 'Friend to the World.webp', 'Popularity'),
  aspiration('neighborhoodconfidante', 'Neighborhood Confidante', A, 'Neighborhood Confidante.webp', 'Popularity'),
  aspiration('leaderofthepack', 'Leader of the Pack', A, 'Leader of the Pack.webp', 'Popularity'),
  aspiration('goodvampire', 'Good Vampire', A, 'Good Vampire.webp', 'Popularity'),
  aspiration('worldfamouscelebrity', 'World-Famous Celebrity', A, 'World Famous Celebrity.webp', 'Popularity'),
  aspiration('discerningdweller', 'Discerning Dweller', A, 'Discerning Dweller.webp', 'Popularity'),
  // ═══ Star Wars ═══
  aspiration('hopevsorder', 'Hope VS Order', A, 'Hope VS Order.webp', 'Star Wars'),
  aspiration('paragonofhope', 'Paragon of Hope', A, 'Paragon of Hope.webp', 'Star Wars'),
  aspiration('enforceroforder', 'Enforcer of Order', A, 'Enforcer of Order.webp', 'Star Wars'),
  aspiration('galacticprivateer', 'Galactic Privateer', A, 'Galactic Privateer.webp', 'Star Wars'),
  // ═══ Wellness ═══
  aspiration('innerpeace', 'Inner Peace', A, 'Inner Peace.webp', 'Wellness'),
  aspiration('selfcarespecialist', 'Self-Care Specialist', A, 'Self-Care Specialist.webp', 'Wellness'),
  aspiration('zenguru', 'Zen Guru', A, 'Zen Guru.webp', 'Wellness'),
  // ═══ Werewolf ═══
  aspiration('werewolfinitiate', 'Werewolf Initiate', A, 'Werewolf Initiate.webp', 'Werewolf'),
  aspiration('lonewolf', 'Lone Wolf', A, 'Lone Wolf.webp', 'Werewolf'),
  aspiration('emissaryofthecollective', 'Emissary of the Collective', A, 'Emissary of the Collective.webp', 'Werewolf'),
  aspiration('wildfangrenegade', 'Wildfang Renegade', A, 'Wildfang Renegade.webp', 'Werewolf'),
  aspiration('cureseeker', 'Cure Seeker', A, 'Cure Seeker.webp', 'Werewolf'),
  // ═══ Child aspirations ═══
  aspiration('artisticprodigy', 'Artistic Prodigy', A_CH, 'Artistic Prodigy.webp', 'Child'),
  aspiration('rambunctiousscamp', 'Rambunctious Scamp', A_CH, 'Rambunctious Scamp.webp', 'Child'),
  aspiration('socialbutterfly', 'Social Butterfly', A_CH, 'Social Butterfly.webp', 'Child'),
  aspiration('whizkid', 'Whiz Kid', A_CH, 'Whiz Kid.webp', 'Child'),
  aspiration('slumberpartyanimal', 'Slumber Party Animal', A_CH, 'Slumber Party Animal.webp', 'Child'),
  aspiration('mindandbody', 'Mind and Body', A_CH, 'Mind and Body.webp', 'Child'),
  aspiration('playtimecaptain', 'Playtime Captain', A_CH, 'Playtime Captain.webp', 'Child'),
  aspiration('creativegenius', 'Creative Genius', A_CH, 'Creative Genius.webp', 'Child'),
  // ═══ Teen aspirations ═══
  aspiration('dramallama', 'Drama Llama', A_T, 'Drama Llama.webp', 'Teen'),
  aspiration('goaloriented', 'Goal Oriented', A_T, 'Goal Oriented.webp', 'Teen'),
  aspiration('livefast', 'Live Fast', A_T, 'Live Fast.webp', 'Teen'),
  aspiration('admiredicon', 'Admired Icon', A_T, 'Admired Icon.webp', 'Teen'),
  // ═══ Limited-Time ═══
  aspiration('positivitychallenge', 'The Positivity Challenge', A, 'Positivity Challenge.webp', 'Limited-Time'),
  // ═══ Tutorial ═══
  aspiration('tutorialtrendsetter', 'Trend-Setter', A_TUT, 'Trend-setter.webp', 'Tutorial'),
  aspiration('tutorialpainter', 'Painter', A_TUT, 'Painter.webp', 'Tutorial'),
  aspiration('tutorialathlete', 'Athlete', A_TUT, 'Athlete.webp', 'Tutorial'),
  aspiration('tutorialchef', 'Chef', A_TUT, 'Chef.webp', 'Tutorial'),
];
